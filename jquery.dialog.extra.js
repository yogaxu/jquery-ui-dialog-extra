...
//--------------------------------------------------------------------------------------------------------------
        ...
        var uiDialogTitlebarMinimize = self.uiDialogTitlebarMinimize = $('<button href="#"></button>')
			.addClass(
				'ui-button ui-widget ui-state-default ui-corner-all ui-button-icon-only ui-dialog-titlebar-min'
			)
			.attr('type', 'button')
			.attr('role', 'button')
			.attr('title', 'minimize')
...
//--------------------------------------------------------------------------------------------------------------
        ...
        var uiDialogTitlebarRest = self.uiDialogTitlebarRest = $('<button href="#"></button>')
			.addClass(
				'ui-button ui-widget ui-state-default ui-corner-all ui-button-icon-only ui-dialog-titlebar-rest'
			)
			.attr('type', 'button')
			.attr('role', 'button')
			.attr('title', 'restore')
...
//--------------------------------------------------------------------------------------------------------------
        ...
        var uiDialogTitlebarMaximize = self.uiDialogTitlebarMaximize = $('<button href="#"></button>')
			.addClass(
				'ui-button ui-widget ui-state-default ui-corner-all ui-button-icon-only ui-dialog-titlebar-max'
			)
			.attr('type', 'button')
			.attr('role', 'button')
			.attr('title', 'maximize')
...
//--------------------------------------------------------------------------------------------------------------
    ...
    $.extend($.ui.dialog.prototype, {
        ...
        minimize: function() { 
            ...
            var titlebarHeight = this.uiDialog.find('.ui-dialog-titlebar').height();
            this.uiDialog.animate({width: 200, height:titlebarHeight+5},200);
            this.element.hide();
            
            this.uiDialog.css("top", "auto");
            this.uiDialog.css("left", "auto");
            this.uiDialog.css("bottom", "0");
            this.uiDialog.css("right", "0");
